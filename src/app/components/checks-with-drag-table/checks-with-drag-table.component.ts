...
@Component({
  selector: 'app-checks-with-drag-table',
  templateUrl: './checks-with-drag-table.component.html',
  styleUrls: ['./checks-with-drag-table.component.scss']
})
export class ChecksWithDragTableComponent implements OnInit {
